...
salinity_clean <- salinity |>  # clean data by cleaning names and renaming column
  clean_names() |> 
  rename(salinity_ms_cm = salinity_m_s_cm)
personal <- read_csv(here("data", "envs193ds-personal-data.csv")) 
personal_clean <- personal |>  # clean data by cleaning names and setting date to date type format
  clean_names() |> 
