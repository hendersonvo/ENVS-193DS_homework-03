...
Since the data I collected was about the number of steps I took everyday, I could create a setting like a trail and use footprints to represent individual observations. I can also use the time series of step counts to act like a mountain range in the background. I can use colors to indicate the magnitude of steps I took, and use different kinds of trimmings to indicate my categorical variables like my on-call status on a particular day. 
